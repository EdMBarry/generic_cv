...
\vspace{0.2mm}
\cvsection{Education}
\cvevent{PhD \ in Chemical Engineering}{University of Queensland}{Apr 2015 -- Nov 2019}{}
%\textbf{Supervisors}: Prof Damien Batstone \textbullet{} 
%Assistant Prof Chris DeGroot \textbullet{} Dr Tim H\"ulsen
...
\cvskill{Git, SQL}{4}
\cvskill{PyTorch, Tensorflow}{3}
\cvskill{R, C++, Fortran, Rust}{2}
